                            ...
                            <div class="a-row a-spacing-small">
                              ...
                              <nuxt-link :to="`/products/${product._id}`" class="a-link-normal">
                                <h2 class="a-size-medium">
                                  ...
                                  <span class="a-letter-space"></span>
                                  <span class="a-size-small a-color-secondary">Nov 27,2021</span>
                                </h2>
                              </nuxt-link>
                            </div>
                            <!--autor's name-->
                              ...
                              <!--shipping-->
                              <div class="a-row">
                                <span class="a-size-small">Ships to Israel</span>
                              </div>
                              <div class="row">
                                <div class="col-sm-7">
                                ...
                                <div class="a-row a-spacing-none">
                                  ...
                                  <span class="a-letter-space"></span>
                                  <span class="a-size-base-plus a-color-secondary a-text-strike">$69.00</span>
                                </div>
                                <!--Audibale Trail-->
                                <div class="a-row a-spacing-none">
                                  <span class="a-size-small a-color-secondary">Free with Audible trail</span>
                                  <hr/>
                                  <!--other formats-->
                                  <span class="a-size-small a-color-secondary">
                                    Other Formats:
