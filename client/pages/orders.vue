              ...
              <div class="row">
                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-2 text-left">
                  <div class="a-row">
                    ...
                    <br />
                    <span class="a-size-base a-text-bold a-color-secondary">{{order.orderDate}}</span>
                  </div>
                </div>
                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-2">
                  <div class="a-row">
                    ...
                    <br />
                    <span class="a-size-base a-text-bold a-color-secondary">${{order.totalPrice}}</span>
                  </div>
                </div>
              ...
              <div v-for="product in order.products" :key="product._id">
                ...
                <div class="row">
                  ...
                  <div class="col-xl-10 col-lg-10 col-10">
                    ...
                    <div class="a-row">
                      <span class="a-size-mini a-color-secondary">Sold by: Barmazon Export Sales </span>
                    </div>
                    <div class="a-row">
                      <!-- Product quantity -->
