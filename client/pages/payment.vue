...
export default {  
  ...
  computed:{
    ...mapGetters(['getCartTotalPriceWithShipping','getCart','getEstimatedDelivery'])
  },
  mounted(){
    this.stripe = Stripe("pk_test_51KC0nGAhZIVgviSTESFBpjNwUQ5Lvt5FFnPtO6UwvHGopaVltKeMtRHD0tDW93oKwG3wSHv6UHKkV0GBIy2fmJvI00BuPlgKf9")
  ...
  methods:{
    async onPurchase(){
      try{
        ...
        let orderDate = await this.$axios.$get('/api/shipment-today');
