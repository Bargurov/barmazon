              ...
              <div class="buyBox">
                ...
                <div class="a-section a-spacing-small">
                  ...
                  <div class="a-section a-spacing-mini">
                    Ships from and sold by Barmazon.com
                  </div>
                </div>
                ...
                <div class="a-section">
                  ...
                  <div
                    class="a-button-stack"
                    @click="buyProductNow({ product, qty })"
                  >
                    <span
                      class="a-spacing-small a-button-primary a-button-icon"
                    >
                  ...
                  <div class="a-spacing-top-small">
                    <div class="a-section a-spacing-none">
                      <div
                        ...
                        v-if="this.$store.$auth.LoggedIn"
                      >
                        This item ships to
                        <b>{{ $auth.state.user.user.address.city }}</b>
                        <b>{{ date }}</b>
                  ...
                  <a href="#" class="a-link-normal">
                    <div class="a-row a-spacing-mini">
                      ...
                      <span
                        ...
                        v-if="this.$store.$auth.LoggedIn"
                        >Deliver to
                        {{ $auth.state.user.user.address.city }}</span
                      >
                      <span class="a-size-small" v-else>Deliver to you </span>
                    </div>
                  </a>
                </span>
                <br />
...
export default {
  ...
  async asyncData({ $axios, params }) {
    try {
      ...
      let dateRange = $axios.$get(`/api/shipment-range`);

      const [productResponse, reviewsResponse, dateResponse] =
        await Promise.all([singleProduct, manyReviews, dateRange]);
      return {
        product: productResponse.products,
        reviews: reviewsResponse.reviews,
        date: dateResponse.shipment,
      };
    } catch (error) {
      console.log(error);
    }
  ...
  methods: {
    ...
    buyProductNow({ product, qty }) {
      if (this.$auth.loggedIn) {
        this.$store.dispatch("addProductToCart", { product, qty });
