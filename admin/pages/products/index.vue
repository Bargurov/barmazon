                  ...
                  <div class="a-section">
                      ...
                      <form>
                          ...
                          <div class="a-spacing-top-medium">
                              ...
                              <textarea 
                              placeholder="Provide details on the product" 
                                 v-model="description"
                              style="width: 100%;">
                              </textarea>
                          </div>
                          ...
                          <div class="a-spacing-top-medium">
                              ...
                              <div class="a-spacing-top-large">
                                  <span class="a-button-register">
                                      ...
                                      <span lass="a-button-text" @click="onAddProduct">Add Product</span>
                                      </span>
                                  </span>
                          </div>
                      </form>
...
export default {
   async asyncData({$axios}){
       try{
        let categories = $axios.$get('http://localhost:4000/api/categories')
       let owners = $axios.$get('http://localhost:4000/api/owners')
