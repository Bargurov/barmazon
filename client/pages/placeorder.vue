  ...
  <div class="container-fluid">
    <div class="shipping-address">
                    ...
                    <div class="a-row">
                      <div class="displayAddressDiv">
                        ...
                        <ul class="displayAddressUL">
                          <li>{{$auth.$state.user.user.address.fullName}}</li>
                          <li>{{$auth.$state.user.user.address.streetAddress}}</li>
                          <li>{{$auth.$state.user.user.address.city}}</li>
                          <li>{{$auth.$state.user.user.address.country}}</li>
                          <li>
                            Phone:
                            <span dir="ltr">{{$auth.$state.user.user.address.phoneNumber}}</span>
                          </li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div class="a-row a-spacing-base" v-for="product in getCart" :key="product._id">
                      <div class="row">
                        ...
                        <div class="col-sm-9 col-9">
                          ...
                          >Sold by:&nbsp;Barmazon.com Services, Inc</div>
                          <div class="a-row">
                      ...
                      <fieldset>
                        ...
                        <div class="a-spacing-mini wednesday">
                          ...
                          <span class="a-radio-label">
                            ...
                            >$13.99&nbsp;-&nbsp;Standard International Shipping - No Tracking</span>
                          </span>
                        </div>
                        <br />
                        <div class="a-spacing-mini tuesday">
                          ...
                          <span class="a-radio-label">
                            ...
                            <br />
                            <span class="a-color-secondary">$24.99&nbsp;-&nbsp;Shipping</span>
                          </span>
                        </div>
                      </fieldset>
                    </div>
            ...
            <div class="a-box a-first">
              <div class="a-box-inner">
                ...
                <div class="a-row a-spacing-small a-size-small a-text-center">
                  By placing your order, you agree to Barmazon's
                  ...
                  <div id="tfx-header">
                    <div class="a-box a-alert-info a-spacing-small">
                      <div class="a-box-inner alert-info-no-icon">
                        <strong>
                          Barmazon Currency Converter is Enabled. &nbsp;
                          <a
                            href="#"
                            class="a-size-mini"
                          >Learn More</a>
                  ...
                  <div class="a-row">
                    ...
                    <fieldset class="pl-3">
                      <span style="margin-left: 1rem;">
                        <input type="radio" class="no-js-hide" value="transactional" checked='checked' />
      ...
      <div class="a-row a-spacing-small a-spacing-top-small">
        ...
        >For an item sold by Barmazon.com: When you click the "Place your order" button, we'll send you an email message acknowledging receipt of your order. Your contract to purchase an item will not be complete until we send you an email notifying you that the item has been shipped.</p>
        ...
        <div class="a-color-secondary a-size-mini">
          <p class="a-color-secondary a-size-mini">
            Within 30 days of delivery, you may return new, unopened merchandise in its original condition. Exceptions and restrictions apply. See Barmazon.com's
            <a
              href="#"
            >Returns Policy</a>
            <br />
            <br />Go to the
            <a href="#">Barmazon.com homepage</a> without completing your order.
          </p>
        </div>
      </div>
      <hr />
      <p class="a-size-small a-text-center a-color-secondary" data-testid>
        <a href="#">Conditions of Use</a> |
        <a href="#">Privacy Notice</a> © 2021-2022, Barmazon.com, Inc.
      </p>
    </div>
  </div>
  <!--/SHIPPING ADDRESS-->
